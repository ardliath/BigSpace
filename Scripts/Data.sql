...
insert into Races (Name, guid) values ('Human', '4DFC5711-4387-4DE9-97CC-E4AB826B8EFE')
declare @human int = scope_identity()
...
insert into Planets(solarsystemid, positionindex, name, image, population, maxpopulation, raceid) values (@earth, 2, 'Earth', 'Earth.png', 6000000000, 9000000000, @human)
...
insert into ships(name, solarsystemid, useraccountid, EmpireID, IsSelected, raceid) values ('USS Enterprise', @earth, @me, @Empire, 0, @human)
